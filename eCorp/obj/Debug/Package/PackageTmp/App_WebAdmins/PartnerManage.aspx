<%@ Page Title="" Language="C#" MasterPageFile="~/App_WebMaster/WebAdmin.Master" AutoEventWireup="true" CodeBehind="PartnerManage.aspx.cs" Inherits="eCorp.App_WebAdmins.PartnerManage" %>
        ...
        <tr>
            <td>
                <asp:GridView ID="gView" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="PartnerID" HeaderText="ID" />
                        <asp:BoundField DataField="PartnerName" HeaderText="Tên khách hàng" />
                        ...
                        <asp:TemplateField HeaderText="Chức năng">
                            <ItemTemplate>
                                <asp:Button ID="btnEdit" runat="server" 
                                    CommandArgument='<%#DataBinder.Eval(Container.DataItem,"PartnerID") %>' 
