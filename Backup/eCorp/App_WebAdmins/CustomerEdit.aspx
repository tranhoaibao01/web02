<%@ Page Title="" Language="C#" MasterPageFile="~/App_WebMaster/WebAdmin.Master" AutoEventWireup="true" CodeBehind="CustomerEdit.aspx.cs" Inherits="eCorp.App_WebAdmins.CustomerEdit" %>
    ...
    <tr>
        <td>
            <table cellpadding="0" cellspacing="5" style="width: 100%">
                <tr>
                    <td width="80">
                        <asp:Label ID="lbCustomerID" runat="server" Text="Mã"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lbCustomerName" runat="server" Text="Tên khách"></asp:Label>
                    </td>
                    <td>
