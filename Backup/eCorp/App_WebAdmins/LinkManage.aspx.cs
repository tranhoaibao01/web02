...
{
    public partial class LinkManage : System.Web.UI.Page
    {
        ...
        {
            gView.DataSource = Links.GetAllOrderByPos();
            gView.DataBind();
        }
        #endregion
        ...
        {
            // Tiêu đề trang
            this.Page.Title = "Quản trị danh mục liên kết";
        ...
        protected void btnInsert1_Click(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(Page, typeof(Page), "OpenWindow",
                "window.open('LinkEdit.aspx?ID=" + idValue + "');", true);
        }
